...
class Particle(object):
    ...
    def make_image(self,surface):
        ...
        if self.texture:
            ...
            scale = pygame.transform.smoothscale(self.texture, rect.size)

            surface.blit(scale, (0, 0))

            surface.fill(self.start_color, special_flags=pygame.BLEND_RGBA_MULT)

        else:

            pygame.draw.ellipse(surface, self.start_color, rect)
